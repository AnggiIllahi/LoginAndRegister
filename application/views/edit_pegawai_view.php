		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<?php echo form_open_multipart('pegawai/update/'.$this->uri->segment(3)); ?>
								<center><h1>Edit Data Pegawai</h1></center><br>
								...
								<tr>
									...
									<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama" aria-describedby="basic-addon3" value="<?php echo $pegawai[0]->nama ?>">
									</td>
								</tr>
								...
								<tr>
									...
									<input type="text" class="form-control" id="nip" name="nip" placeholder="Masukkan NIP" aria-describedby="basic-addon3" value="<?php echo $pegawai[0]->nip ?>" >
									</td>
								</tr>
								<tr>
									<td>
									...
									<input type="date" format="dd/mm/yyyy" placeholder="Masukkan Tanggal Lahir" class="form-control" id="tgllahir" name="tgllahir" aria-describedby="basic-addon3" value="<?php echo $pegawai[0]->tanggalLahir ?>" >
									</td>
								</tr>
								<tr>
									<td>
									...
									<textarea rows="3" cols="20" placeholder="Masukkan Alamat" class="form-control" id="alamat" name="alamat"><?php echo $pegawai[0]->alamat ?></textarea>
									</td>
								</tr>
								...
								<tr>
									...
									<input type="file" class="form-control" id="userfile" name="userfile" aria-describedby="basic-addon3" value="<?php echo $pegawai[0]->foto?>">
									<img src="<?php echo base_url()?>assets/uploads/<?php echo $pegawai[0]->foto;?>" height=150>
									</td>
								</tr>
