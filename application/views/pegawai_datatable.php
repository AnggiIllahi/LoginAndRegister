	...
	<body>
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									<ul class="nav navbar-nav">
								        ...
								        <li class="active"><a href="<?php echo site_url('pegawai/DataTable') ?>">DataTable Pegawai</a></li>
									</ul>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1>Daftar Pegawai <br> <a href="<?php echo site_url()?>/pegawai/create/<?php echo $this->uri->segment(3)?>" class="btn btn-warning"> <span class="glyphicon glyphicon-plus"></span> Tambah Pegawai</a> </h1>
							...
							<table class="table table-hover" id="example">
								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td align="center">
											<a href="<?php echo site_url('jabatan/index/').$key->id ?>" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span> Jabatan</a>
											<a href="<?php echo site_url('anak/index/').$key->id ?>" class="btn btn-success" role="button"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Anak</a>
